# Лабораторная №1
Дана текст и длина требуемой строки. <br/>Выровнять строки по центру. <br/>Обработать ситуации, когда строки исходного текста имеют длину больше, чем заданная длина (перенести лишние слова) и исходные строки не содержат пробелов.<br/>
Текст читаем из файла. Имя файла и длинна строки задаются с помощью аргументов командной строки.<br/>
...
3.	Печатаем, полученные строчки, добавляя пробелы, если это необходимо<br/>
